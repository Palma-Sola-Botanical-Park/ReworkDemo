...
<style>
  ...
  .wild-float-back{{ position:fixed;bottom:24px;left:50%;transform:translateX(-50%); background:#235e86;color:#fff;font-size:15px;font-weight:700;padding:10px 22px;border-radius:30px; text-decoration:none;box-shadow:0 4px 16px rgba(0,0,0,0.25);z-index:800;display:flex;align-items:center;gap:8px; transition:background .2s,transform .2s;white-space:nowrap; }}
  .wild-float-back:hover{{ background:#143b54;transform:translateX(-50%) translateY(-2px);color:#fff; }}
